...
function setup() {
  ...
  covifighter.scale =1;
   ...
   plays = createSprite(displayWidth-650,displayHeight-550)
   plays.addImage(p1_Image);
   plays.scale = 0.65;

   htp = createSprite(displayWidth-650,displayHeight-350)
   htp.addImage(htp_Image);
   htp.scale = 0.65;

   pwm = createSprite(displayWidth-650,displayHeight-150);
   pwm.addImage(pwm_1);
   pwm.scale = 1;
...
End_Slogan = createSprite(displayWidth-690,displayHeight-460);
...
if(mousePressedOver(back2)){
  ...
  plays.x = displayWidth-650
  htp.x = displayWidth-650
 
  
  pwm.x = displayWidth-650;
  pwm.scale = 1;
...
if(mousePressedOver(htp)){
  ...
  mask.visible = false;
  htps.scale = 1;
  htps.y = displayHeight-500;
  plays.x = displayWidth-10000000000000;
  htp.x = displayWidth-1000000;
  //goodperson.destroy();
